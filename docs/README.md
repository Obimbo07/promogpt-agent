...
| [roadmap](./roadmap.md) | V1/V2/V3 objectives; **V1 completion path** (Groq → Gemini first, then other providers) |
...
| [integrations-social](./integrations-social.md) | Social adapter layer + REST endpoints + onboarding flows |
