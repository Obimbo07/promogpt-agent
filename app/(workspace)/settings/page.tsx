  ...
  return (
    <section className="mx-auto flex w-full max-w-3xl flex-col gap-10">
      <div>
        ...
        <p className="mt-2 text-muted-foreground">Authentication, quotas, integrations — stubs for production wiring.</p>
      </div>
      ...
      <Card className="rounded-2xl border-border/70 bg-card/85 shadow-elevated">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Input defaultValue="PromoGPT core" placeholder="Marketing flagship" />
          </div>
          <div className="space-y-2">
            <label className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">
              Notifications email
            </label>
            <Input type="email" defaultValue="you@promogpt.app" />
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="rounded-2xl border-border/70 bg-card/85 shadow-elevated">
        ...
        <CardFooter className="justify-between gap-3">
          <Button variant="destructive">Pause workspace</Button>
