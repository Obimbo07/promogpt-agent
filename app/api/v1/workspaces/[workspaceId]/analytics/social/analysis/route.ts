...
/**
 * Full AI analysis over ingested social posts + connector snapshots:
 * account health, per-platform post breakdown, and distinct viral playbooks (TikTok / Instagram / Facebook).
 */
